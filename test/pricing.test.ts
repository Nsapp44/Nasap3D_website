...
import { computePrice, discountForQty } from "../src/lib/server/pricing";
...
// PRICING.md for the formula writeup: unit price = max(price floor, hourly
// rate x print time + material cost). No separate margin/setup fee (any
// margin lives directly in each material's price-per-kg instead).
