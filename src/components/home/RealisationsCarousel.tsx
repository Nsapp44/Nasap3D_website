...
const REALISATIONS = [
  { img: "/assets/real-1.webp", label: "Maquette filtration systems", desc: "Reproduction détaillée d'un système de chromatographie, vue d'ensemble." },
  { img: "/assets/real-2.webp", label: "filtration systems — face avant", desc: "Panneau fluidique, vannes et tubulures fonctionnels à l'échelle." },
  { img: "/assets/real-3.webp", label: "filtration systems — vue 3/4", desc: "Châssis, tubulures et raccords fonctionnels à l'échelle." },
  { img: "/assets/real-4.webp", label: "Trophée cerf", desc: "Découpe laser multi-couches en bois, montage mural." },
  { img: "/assets/real-5.webp", label: "Caravanes Fendt miniatures", desc: "Série de modèles réduits imprimés et détaillés." },
  { img: "/assets/real-6.webp", label: "Rondin gravé mariage", desc: "Gravure laser personnalisée sur tranche de bois." },
  { img: "/assets/real-7.webp", label: "Médaille animal gravée", desc: "Gravure fibre sur médaille inox personnalisée." },
  { img: "/assets/real-8.webp", label: "Maquette cellule — vue de face", desc: "Modèle pédagogique en coupe, pièces multicolores." },
  { img: "/assets/real-9.webp", label: "Maquette cellule", desc: "Modèle pédagogique en coupe, pièces multicolores." },
  { img: "/assets/real-10.webp", label: "Engrenage métal inox 316L", desc: "Impression 3D métal, engrenage technique en acier inoxydable 316L." },
  { img: "/assets/real-11.webp", label: "Bloc manifold fluidique", desc: "Manomètres et vannes imprimés pour banc de test." },
  { img: "/assets/real-12.webp", label: "Pièce rétro-conçue", desc: "Réducteur redessiné en CAO à partir de la pièce d'origine usée." },
  { img: "/assets/real-13.webp", label: "Verres personnalisés", desc: "Gravure laser sur manchon cuir, personnalisation au prénom." },
  { img: "/assets/real-14.webp", label: "Petite série technique", desc: "Pièce en TPU noir 90A, série de 528 unités." },
  { img: "/assets/real-15.webp", label: "Formes pédagogiques", desc: "Pièces d'illustration multicolores pour le secteur santé." },
  { img: "/assets/real-16.webp", label: "Figurines résine SLA", desc: "Impression résine haute définition prête pour peinture." },
  { img: "/assets/real-17.webp", label: "Objets liturgiques", desc: "Maquettes de design produit pour une présentation." },
  { img: "/assets/real-18.webp", label: "Cache Peugeot 102", desc: "Cache personnalisé imprimé pour Peugeot 102." },
];
const REAL_MAX = 6;
const GAP = 32;
const AUTO_MS = 3500;
