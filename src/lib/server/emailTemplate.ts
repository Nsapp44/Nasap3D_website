// Gabarit HTML partagé pour tous les emails transactionnels. Mise en page en
// <table> + CSS inline : les clients mail (Outlook en particulier) ne
// supportent ni flexbox ni grid ni <style> externe fiable.
